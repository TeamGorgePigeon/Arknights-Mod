    ...
    public void inventoryTick(@Nonnull ItemStack stack, World world, @Nonnull Entity entity, int par4, boolean par5) {
        ...
        if(this.tick == SkillCD-1 && !this.isSkill){
            ...
            switch (new Random().nextInt(4)){
                case 0:
                    world.playSound(null, entity.getPosX(), entity.getPosY(), entity.getPosZ(), SoundHandler.EXUSIAI_SKILL1, SoundCategory.NEUTRAL, 1.0F, 1.0F);
                    //System.out.print(0);
                    break;
                case 1:
                    world.playSound(null, entity.getPosX(), entity.getPosY(), entity.getPosZ(), SoundHandler.EXUSIAI_SKILL2, SoundCategory.NEUTRAL, 1.0F, 1.0F);
                    //System.out.print(1);
                    break;
                case 2:
                    world.playSound(null, entity.getPosX(), entity.getPosY(), entity.getPosZ(), SoundHandler.EXUSIAI_SKILL3, SoundCategory.NEUTRAL, 1.0F, 1.0F);
                    //System.out.print(2);
                    break;
                case 3:
                    world.playSound(null, entity.getPosX(), entity.getPosY(), entity.getPosZ(), SoundHandler.EXUSIAI_SKILL4, SoundCategory.NEUTRAL, 1.0F, 1.0F);
                    //System.out.print(3);
                    break;
                default:
                    world.playSound(null, entity.getPosX(), entity.getPosY(), entity.getPosZ(), SoundHandler.EXUSIAI_SKILLATTACK, SoundCategory.NEUTRAL, 1.0F, 1.0F);
                    //System.out.print(4);
                    break;
            }
             */
        ...
        if(this.pressed && this.tick2%this.delay == 1){
            ...
            Vector3d vec3d= entity.getPositionVec();
            ...
            if(!this.isSkill){
                ...
                world.playSound(null, entity.getPosX(), entity.getPosY(), entity.getPosZ(), SoundHandler.EXUSIAI_ATTACK, SoundCategory.NEUTRAL, 1.0F, 1.0F + (world.rand.nextFloat() - world.rand.nextFloat()) * 0.4F);
            } else {
                for(int i = 0;i < 4;i++){
                ...
                world.playSound(null, entity.getPosX(), entity.getPosY(), entity.getPosZ(), SoundHandler.EXUSIAI_SKILLATTACK, SoundCategory.NEUTRAL, 1.0F, 1.0F + (world.rand.nextFloat() - world.rand.nextFloat()) * 0.4F);
                this.tick2 += 4;
            }
