...
public class OriginiumSlugModel<T extends Entity> extends SegmentedModel<T> {
   ...
   public OriginiumSlugModel() {
      ...
      for(int i = 0; i < this.field_78171_a.length; ++i) {
         this.field_78171_a[i] = new ModelRenderer(this, ORIGINIUMSlUG_TEXTURE_POSITIONS[i][0], ORIGINIUMSlUG_TEXTURE_POSITIONS[i][1]);
         this.field_78171_a[i].func_228300_a_((float)ORIGINIUMSlUG_BOX_LENGTH[i][0] * -0.5F, 0.0F, (float)ORIGINIUMSlUG_BOX_LENGTH[i][2] * -0.5F, (float)ORIGINIUMSlUG_BOX_LENGTH[i][0], (float)ORIGINIUMSlUG_BOX_LENGTH[i][1], (float)ORIGINIUMSlUG_BOX_LENGTH[i][2]);
         this.field_78171_a[i].setRotationPoint(0.0F, (float)(24 - ORIGINIUMSlUG_BOX_LENGTH[i][1]), f);
         this.zPlacement[i] = f;
      ...
      this.field_78169_b[0].func_228300_a_(-5.0F, 0.0F, (float)ORIGINIUMSlUG_BOX_LENGTH[2][2] * -0.5F, 10.0F, 8.0F, (float)ORIGINIUMSlUG_BOX_LENGTH[2][2]);
      this.field_78169_b[0].setRotationPoint(0.0F, 16.0F, this.zPlacement[2]);
      this.field_78169_b[1] = new ModelRenderer(this, 20, 11);
      this.field_78169_b[1].func_228300_a_(-3.0F, 0.0F, (float)ORIGINIUMSlUG_BOX_LENGTH[4][2] * -0.5F, 6.0F, 4.0F, (float)ORIGINIUMSlUG_BOX_LENGTH[4][2]);
      this.field_78169_b[1].setRotationPoint(0.0F, 20.0F, this.zPlacement[4]);
      this.field_78169_b[2] = new ModelRenderer(this, 20, 18);
      this.field_78169_b[2].func_228300_a_(-3.0F, 0.0F, (float)ORIGINIUMSlUG_BOX_LENGTH[4][2] * -0.5F, 6.0F, 5.0F, (float)ORIGINIUMSlUG_BOX_LENGTH[1][2]);
