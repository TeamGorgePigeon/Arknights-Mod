...
public class ProjektRedEntity extends MeleeOperator {
    ...
    public void summonEffectParticle(World world,Vec3d vec3d) {
        ...
        for (int y=1;y<=77;y++) {
            for (int x=1;x<=effectParticle[1].length()-1;x++){
                ...
                if (effectParticle[y].charAt(x)=='#') {
                    ...
                    world.addParticle(ParticleTypes.CLOUD,startX+x*0.05,startY-y*0.05,vec3d.z,0,0,0);
                }
            }
        }
    }
    ...
    public void livingTick() {
        if (onSpawn) {
            ...
            summonEffectParticle(this.world,vec3d);
            onSpawn=false;
        }
        super.livingTick();
    }
