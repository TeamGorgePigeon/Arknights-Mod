...
public class EnemyCrossbowAttackGoal<T extends MonsterEntity & IRangedAttackMob & ICrossbowUser> extends Goal {
    private final T field_220748_a;
    private EnemyCrossbowAttackGoal.CrossbowState field_220749_b = EnemyCrossbowAttackGoal.CrossbowState.UNCHARGED;
    ...
    public EnemyCrossbowAttackGoal(T p_i50322_1_, double p_i50322_2_, float p_i50322_4_) {
    ...
    public void resetTask() {
        ...
        if (this.field_220748_a.isHandActive()) {
            ...
            FaustCrossBow.setCharged(this.field_220748_a.getActiveItemStack(), false);
        }
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.field_220749_b == EnemyCrossbowAttackGoal.CrossbowState.UNCHARGED) {
                if (!flag2) {
                    this.field_220748_a.setActiveHand(ProjectileHelper.getHandWith(this.field_220748_a, Items.CROSSBOW));
                    this.field_220749_b = EnemyCrossbowAttackGoal.CrossbowState.CHARGING;
                    ((ICrossbowUser)this.field_220748_a).setCharging(true);
                }
            } else if (this.field_220749_b == EnemyCrossbowAttackGoal.CrossbowState.CHARGING) {
                if (!this.field_220748_a.isHandActive()) {
                    this.field_220749_b = EnemyCrossbowAttackGoal.CrossbowState.UNCHARGED;
                }
                ...
                if (i >= CrossbowItem.getChargeTime(itemstack)) {
                    ...
                    this.field_220749_b = EnemyCrossbowAttackGoal.CrossbowState.CHARGED;
                    this.field_220753_f = 20 + this.field_220748_a.getRNG().nextInt(20);
                    ((ICrossbowUser)this.field_220748_a).setCharging(false);
                }
            } else if (this.field_220749_b == EnemyCrossbowAttackGoal.CrossbowState.CHARGED) {
                --this.field_220753_f;
                if (this.field_220753_f == 0) {
                    this.field_220749_b = EnemyCrossbowAttackGoal.CrossbowState.READY_TO_ATTACK;
                }
            } else if (this.field_220749_b == EnemyCrossbowAttackGoal.CrossbowState.READY_TO_ATTACK && flag) {
    ...
    private boolean func_220747_j() {
        return this.field_220749_b == EnemyCrossbowAttackGoal.CrossbowState.UNCHARGED;
    }
