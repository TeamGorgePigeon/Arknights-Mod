...
public class BlockHandler {
    ...
    public static final Block ORIGINITEPRIME_BLOCK = new OriginiumPrimeBlock(Block.Properties.create(Material.GLASS).hardnessAndResistance(0.3F).sound(SoundType.GLASS)).setRegistryName(MODID+":"+"originite_prime_block");
    ...
    public static final Block ORUNDUM = new GlassBlock(Block.Properties.create(Material.GLASS).hardnessAndResistance(0.3F).sound(SoundType.GLASS)).setRegistryName(MODID + ":orundum");
