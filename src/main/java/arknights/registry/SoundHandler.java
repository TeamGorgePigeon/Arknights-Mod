...
public class SoundHandler {
    ...
    public static final SoundEvent ANSEL_COMBATING1 = sound("ansel_combating1");
    public static final SoundEvent ANSEL_COMBATING2 = sound("ansel_combating2");
    ...
    public static final SoundEvent ENEMYW_GRENADE = sound("enemyw_grenade");
    public static final SoundEvent ENEMYW_SKILL_GRENADE = sound("enemyw_skill_grenade");

    public static final SoundEvent SKILL_ENEMYWCOUNTDOWN = sound("skill_enemywcountdown");
    ...
    public static void register(RegistryEvent.Register<SoundEvent> evt) {
        ...
        r.registerAll(ANSEL_COMBATING1,ANSEL_COMBATING2,EXUSIAI_ATTACK,EXUSIAI_SKILLATTACK,EXUSIAI_COMBATING1,EXUSIAI_COMBATING2,EXUSIAI_COMBATING3,EXUSIAI_COMBATING4,SHAW_COMBATING1,SHAW_COMBATING2,SHAW_COMBATING3,SHAW_COMBATING4,PROJEKTRED_COMBATING1,PROJEKTRED_COMBATING2,PROJEKTRED_COMBATING3,PROJEKTRED_COMBATING4,SKILL_HYDRAULIC,SKILL_WOLFROAR,SKILL_TRUESILVER_SLASH,ENEMYW_GRENADE,ENEMYW_SKILL_GRENADE,SKILL_ENEMYWCOUNTDOWN,ENEMY_DEAD,OPERATOR_DEAD);
    }
}
